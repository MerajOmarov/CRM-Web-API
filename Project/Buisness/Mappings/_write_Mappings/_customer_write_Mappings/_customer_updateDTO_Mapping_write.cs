...
{
    public  class _customer_updateDTO_Mapping_write:Profile
    {
        public _customer_updateDTO_Mapping_write()
        {
            CreateMap<_customer_Model_write, _customer_UpdateDTO_respons>();
        }
    }
}
